...
arr7.splice(1, 2) // 1번째부터 2개를 지워라(삽입값은 없습니다.)
...
arr8.slice(1, 10000) // index에 없는 값도 오류가 생기지 않습니다! splice도 마찬가지입니다.
arr8.slice(100, 10000) // index에 없는 값도 오류가 생기지 않습니다! splice도 마찬가지입니다.