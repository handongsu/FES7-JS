...
// includes, indexOf, search, (replace 이런 것으로도 풀 수 있습니다. 예를 들어 'paullab CEO leehojun'에서 CEO를 찾는다고 했을 때, CEO를 replace해서
//문자열이 줄어들었거나 늘어났으면 그 문자가 포함되어있는 것인지 확인할 수 있습니다.)
...
// 머쓱이는 추운 날에도 아이스 아메리카노만 마십니다. 아이스 아메리카노는 한잔에 5,500원입니다. 머쓱이가 가지고 있는 돈 money가 매개변수로 주어질 때, 머쓱이가 최대로 마실 수 있는 아메리카노의 잔 수와
